      ...
      <div className="container">
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-white/70 text-lg md:text-xl max-w-xs mx-auto tracking-tighter text-center mt-5 px-4">
              Archieve clear,impactful results without the complexity.
            </p>
